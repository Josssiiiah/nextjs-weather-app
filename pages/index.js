...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Search  */}
      <div className="relative flex justify-between items-center max-w-[500px] w-ful m-auto pt-4 text-white z-10">
        <form
          onSubmit={fetchWeather}
          className="flex justify-between items-center w-full m-auto p-4 bg-transparent border border-gray-300 text-white rounded-2xl"
        >
          <div>
            <input
